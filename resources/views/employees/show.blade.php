        ...
        <section class="section">
            <article class="card employee-profile">
                ...
                <div class="employee-info-grid">
                    ...
                    <!-- إحصائيات الحضور (مؤقتاً حتى ربطها بقاعدة البيانات) -->
                    <section class="info-section">
                        <header class="info-section-header">
                        ...
                        <div class="info-section-body">
                            @php
                                ...
                                $attendanceCount = \App\Models\AttendanceRecord::where('employee_id', $employee->id)
                                    ->where('date', 'like', $currentMonth . '%')
                                    ->whereNotNull('check_in')
                                    ->count();

                                $absenceCount = \App\Models\LeaveRequest::where('employee_id', $employee->id)
                                    ->where('status', 'approved')
                                    ->where('start_date', 'like', $currentMonth . '%')
                                    ->orWhere('end_date', 'like', $currentMonth . '%')
                                    ->count();
                            @endphp
                            <div class="info-row">
                                <span class="info-label">أيام الحضور هذا الشهر:</span>
                                <span class="info-value">{{ $attendanceCount }} يوم</span>
                            </div>
                            <div class="info-row">
                                <span class="info-label">أيام الغياب:</span>
                                <span class="info-value">{{ $absenceCount }} يوم</span>
                            </div>
                            <div class="info-row">
                                <span class="info-label">مرات التأخر:</span>
                                <span class="info-value">جاري الحساب...</span>
                            </div>
                        </div>
                    </section>
                </div>
